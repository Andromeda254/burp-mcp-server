...
public class WebSocketLoggingRule implements WebSocketMessageInterceptorRule {
    ...
    public String getDescription() {
        return "Logs WebSocket message details";
    }
    
    @Override
    public int getPriority() {
        return 90; // Low priority - logging happens last
    }
}
